...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const assessmentUrl = `${req.headers.get("origin") || "https://sxrfrzkzuiuxzktctxya.supabase.co"}/assessment/${clientId}`;
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <p style="color: #888; font-size: 14px;">
            Or copy this link: <a href="${assessmentUrl}" style="color: #4F46E5;">${assessmentUrl}</a>
          </p>
